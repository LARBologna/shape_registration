...
{ 
  ...
  { 
    ...
    {                 
      ...
      auto duration_icp = std::chrono::duration_cast<std::chrono::milliseconds>(end_icp - start_icp); 
      std::cout << "PCL CPU ICP duration: " << duration_icp.count() << std::endl;
      ...
      auto duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start); 
	    std::cout << "PCL CPU duration: " << duration.count() << std::endl;
    }      
